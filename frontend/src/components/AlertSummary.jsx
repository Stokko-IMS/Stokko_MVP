  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
      <div className="metric-card">
        <p className="text-sm-bold text-amber-600">Total alerts</p>
        <h3 className="metric-value">{items.length}</h3>
      </div>
      <div className="metric-card">
        <p className="flex items-center gap-2 text-sm-bold text-red-600">
          <AlertOctagon size={20} /> Stockout
        </p>
        <h3 className="metric-value">{stockout}</h3>
      </div>
      <div className="metric-card">
        <p className="flex items-center gap-2 text-sm-bold text-amber-600">
